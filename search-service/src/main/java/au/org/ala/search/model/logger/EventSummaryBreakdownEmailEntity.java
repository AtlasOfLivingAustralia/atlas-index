...
@Data
@Entity
@Table(name = "event_summary_breakdown_email_entity")
@IdClass(EventSummaryBreakdownEmailEntity.EventSummaryBreakdownEmailEntityId.class)
public class EventSummaryBreakdownEmailEntity {
    @Id
    ...
    @Data
    @NoArgsConstructor
    public static class EventSummaryBreakdownEmailEntityId implements Serializable {
        private String month;
        private Integer logEventTypeId;
        private String userEmailCategory;
        private String entityUid;
