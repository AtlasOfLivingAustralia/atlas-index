...
@Data
@Entity
@Table(name = "event_summary_breakdown_reason_entity")
@IdClass(EventSummaryBreakdownReasonEntity.EventSummaryBreakdownReasonEntityId.class)
public class EventSummaryBreakdownReasonEntity {
    @Id
    ...
    @Data
    @NoArgsConstructor
    public static class EventSummaryBreakdownReasonEntityId implements Serializable {
        private String month;
        private Integer logEventTypeId;
        private Integer logReasonTypeId;
        private String entityUid;
