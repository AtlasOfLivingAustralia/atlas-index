...
@Data
@Entity
@Table(name = "event_summary_breakdown_reason")
@IdClass(EventSummaryBreakdownReason.EventSummaryBreakdownReasonId.class)
public class EventSummaryBreakdownReason {
    @Id
    ...
    @Data
    @NoArgsConstructor
    public static class EventSummaryBreakdownReasonId implements Serializable {
        private String month;
        private Integer logEventTypeId;
        private Integer logReasonTypeId;
    }
