                ...
                <div className='col-12'>
                    <div className='d-flex justify-content-center'>
                        ...
                        {Array.from(Array(9).keys()).map(idx => {
                            ...
                            let maxPages = Math.ceil((results.totalRecords ?? 0) / pageSize);
                        ...
                        {page * pageSize < (results.totalRecords ?? 0) && Math.min(20, page + 4) < Math.ceil((results.totalRecords ?? 0) / pageSize) && <button className='btn btn-outline-dark btn-sm ms-1'>..</button>}

                        {page * pageSize < (results.totalRecords ?? 0) && page < 20 && (
                            <button className='btn btn-outline-dark btn-sm ms-1' onClick={() => setPage(page + 1)}>
