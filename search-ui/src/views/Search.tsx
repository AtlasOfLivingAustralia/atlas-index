    ...
    return (
        <>
            <div
                ...
                style={{ marginTop: isMobile ? '0px' : '-47px' }}
            >
                <div
                    style={{
                ...
                >
                    ...
                    {isMobile && (
                        <div className={'d-flex justify-content-center '}>
                            <select
                                className={
                                    'form-select ' + classes.mobileSelect
                                }
                                value={tab}
                                onChange={(event) => {
                            ...
                            >
                                ...
                                <option value="dataprojects">
                                    Data projects
                                </option>
                                <option value="datasets">Datasets</option>
                                <option value="alageneralcontent">
                                    General content
                                </option>
                                <option value="helparticles">
                                    Help articles
                                </option>
                                <option value="regionslocalities">
                                    Locations
                                </option>
                                <option value="environmentallayers">
                                    Spatial layers
                                </option>
                                <option value="species">Species</option>
                                <option value="specieslists">
                                    Species lists
                                </option>
                            </select>
                        </div>
                ...
                {!isMobile && (
                    ...
                    >
                        <div
                            className={`${tab === 'all' ? classes.activeTab : ''} ${classes.tabButtons}`}
                        ...
                        <div
                            className={`${tab === 'species' ? classes.activeTab : ''} ${classes.tabButtons}`}
                        ...
                        <div
                            className={`${tab === 'specieslists' ? classes.activeTab : ''} ${classes.tabButtons}`}
                        ...
                        <div
                            className={`${tab === 'dataprojects' ? classes.activeTab : ''} ${classes.tabButtons}`}
                        ...
                        <div
                            ...
                            onClick={() =>
                                handleTabChange('environmentallayers')
                            }
                        >
                            {/*<SpatialLayersIcon/>*/}
                            Spatial layers
                        ...
                        <div
                            className={`${tab === 'regionslocalities' ? classes.activeTab : ''} ${classes.tabButtons}`}
                        ...
                        <div
                            className={`${tab === 'alageneralcontent' ? classes.activeTab : ''} ${classes.tabButtons}`}
                        ...
                        <div
                            className={`${tab === 'helparticles' ? classes.activeTab : ''} ${classes.tabButtons}`}
