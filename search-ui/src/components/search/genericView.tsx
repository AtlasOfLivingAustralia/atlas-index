                ...
                {!facetLoading && !customFacetLoading && [...facets, ...customFacetData].sort((a, b) => a.order - b.order).map((facet: any, index: number) => (
                    <div key={index}>
                        ...
                        {facet.lessNumber && facet.items.length > facet.lessNumber && (
                            facet.more ?
                                <div onClick={() => {facet.more = false;setFacets([...facets]);}} style={{marginTop: '8px', color: 'var(--ala-accent-color, #c44d34)'}}>
                                ...
                                :
                                <div onClick={() => {facet.more = true;setFacets([...facets]);}} style={{marginTop: '8px', color: 'var(--ala-accent-color, #c44d34)'}}>
        ...
        <div className="row" style={{ marginLeft: '0px', marginRight: '0px' }}>
            ...
            <div className={isMobile ? 'col-12' : 'col-9'}>
                ...
                {maxResults > 0 && (<>
                        <div className="d-flex justify-content-between"
                            ...
                            <div className="d-flex align-items-center gap-3">
                                ...
                                <select className={`form-select ${classes.alaSelect}`} value={sortValue}
                                        onChange={(e) => {
                ...
                {loading && <div className="placeholder-glow"
                                 style={{height: filter === 'list' ? '1185px' : '1595px'}}>Loading...</div>}
                {!loading && <>
                    {filter == 'list' &&
