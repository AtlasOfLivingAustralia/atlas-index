...
const renderGenericListItemFn = (
    { wide, isMobile }: RenderItemParams,
    elements: RenderItemElements
) => {
    const hasImage =
    ...
    return (
        <div
            className={'d-flex align-items-start flex-row gap-4'}
        ...
        >
            ...
            {elements.description && (
                <div
                    style={{ minWidth: '100px', maxWidth: thirdColMaxWidth }}
...
const renderGenericTileItemFn = (
    ...
    return (
        <div
            className={
                (hasImage ? classes.tile : classes.tileNoImage) +
                (isMobile ? ' d-flex flex-row align-items-start' : '')
            }
            onClick={() => elements.clickFn()}
        >
