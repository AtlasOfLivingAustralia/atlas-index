    ...
    useEffect(() => {
        ...
        fetch(
            import.meta.env.VITE_APP_BIOCACHE_URL +
                ...
                '"&pageSize=0&facet=true&facets=dataResourceUid',
            {
            ...
            .then((data) => {
                ...
                fetch(
                    import.meta.env.VITE_APP_BIE_URL +
                        '/v2/search?q=idxtype:DATARESOURCE&fq=' +
                        encodeURIComponent(drs.join(' OR ')) +
                        '&fl=id,license&pageSize=1000',
                    {
                        headers: {
