    ...
    return (
        <div className="descriptionPage">
            <InfoBox
                ...
                content={
                    <>
                        Descriptive content has been sourced from several
                        authoritative sources of information e.g. museums and
                        herbaria. Links to further information are included in
                        each section.
                    </>
                }
            />
            ...
            {descriptions === undefined && (
                <div className="placeholder-glow">
                    <span
                        ...
                        style={{ height: 40, display: 'block', width: '300px' }}
                    ></span>
                    <span
                        className="placeholder"
                        style={{
                    ...
                    <span
                        className="placeholder"
                        style={{ height: 24, display: 'block', width: '100px' }}
                    ></span>
                    <span
                        className="placeholder"
                        style={{
                        ...
                        {description &&
                            Object.keys(description).map(
                                (key, idx) =>
                                    ...
                                    !['name', 'attribution', 'url'].includes(
                                        key
                                    ) && (
                                        <div
                                            key={idx}
                                            className={classes.speciesSection}
                                        ...
                                        >
                                            ...
                                            {'summary' !== key && (
                                                <span
                                                    ...
                                                    className={
                                                        classes.speciesDescriptionSection
                                                    }
                                                >
                                                    {key}
                                                </span>
