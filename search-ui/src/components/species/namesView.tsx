...
import DisambiguationView from './disambiguationView.tsx';
    ...
    return <>
        <div>
            ...
            {indigenousNames && indigenousNames.length > 0 && <>
                <hr/>
                <div style={{height: isMobile ? '15px' : '30px'}}/>
                <span id="indigenous-names-heading" className={classes.speciesDescriptionTitle}>
                    Indigenous names
                </span>
                <div style={{height: isMobile ? '15px' : '30px'}}/>
                <InfoBox
            ...
            <DisambiguationView result={result} isMobile={isMobile}/>
        </div>
    </>;
}
