        ...
        if (result?.guid) {
            fetch(
                import.meta.env.VITE_APP_BIE_URL +
                    '/v2/search?q=idxtype:TAXON&fq=-acceptedConceptID:*&fq=parentGuid:"' +
                ...
                .then((data) => {
                    if (data?.searchResults) {
                        data.searchResults.sort((a: any, b: any) =>
                            a.nameComplete < b.nameComplete
                                ? -1
                                : a.nameComplete > b.nameComplete
                                  ? 1
                                  : 0
            ...
            <InfoBox
                ...
                content={
                    <>
                        ...
                        <a
                            target="_blank"
                            href={import.meta.env.VITE_TAXONOMY_INTRO_URL}
                ...
                {!loading && hierarchy.length === 0 && (
                    <>
                        ...
                        >
                            <span
                                className="fw-bold"
                                style={{ minWidth: 110, fontSize: '16px' }}
                            >
                ...
                {children &&
                    children.map((child, idx) => (
                        <div
                            ...
                            style={{
                                marginLeft:
                                    Math.max(1, hierarchy.length) * 20 +
                                    1 +
                                    'px',
                            }}
                        >
