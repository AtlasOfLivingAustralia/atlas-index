...
function MapView() {
    ...
    return (
        <>
                ...
                <div className="row">
                    ...
                    <div className="col-4">
                        <Tabs
                            ...
                            className=""
                        >
                            <Tab eventKey="a" title="tab a">

                            </Tab>
                            <Tab eventKey="b" title="tab b">
                                <MapContainer center={new LatLng(51.5, -0.09)} zoom={6} scrollWheelZoom={false}>
                                    <TileLayer
            ...
            OpenLayers map, disabled while trying Leaflet
            {/*<div className="container-fluid">*/}
            {/*    <>*/}
            {/*        {mapDiv()}*/}
